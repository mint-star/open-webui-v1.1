	...
	>
		...
		<div class="my-2">
			...
			<div class="px-1.5 flex justify-center text-gray-800 dark:text-gray-200">
				<a
					class="grow flex items-center space-x-3 rounded-lg px-2 py-[7px] hover:bg-white dark:hover:bg-gray-900 transition"
					href={PUBLIC_SCRIPT_STUDIO} target="_blank"
					on:click={() => {
						selectedChatId = null;
						chatId.set('');
		...
		<div class="px-2">
			<div class="flex flex-col font-primary">
				{#if $user !== undefined && $user !== null}
					...
					>
						<button
							class="flex items-center rounded-xl py-2.5 px-2.5 w-full bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition"
							on:click={() => {
