...
<div bind:this={folderElement} class="relative {className}">
	...
	{#if collapsible}
		...
		>
			...
			<div
				class="w-full group rounded-md relative flex items-center justify-between hover:bg-white dark:hover:bg-gray-900 text-gray-500 dark:text-gray-500 transition"
			>
